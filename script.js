...
const quizData = {
  ...
  geography: {
    ...
    medium: [
      ...
      { q: "What is the Tallest mountain?", options: ["K2","Everest","Kilimanjaro","Makalu"], answer: "Everest" },
      { q: "What is the name os the Desert in China?", options: ["Sahara","Gobi","Thar","Kalahari"], answer: "Gobi" },
    ],
    hard: [
      ...
      { q: "Lake Baikal is in which Country?", options: ["Russia","China","Mongolia","Kazakhstan"], answer: "Russia" },
